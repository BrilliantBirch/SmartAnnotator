...
作者: LiFei
创建日期: 2025-02-24
最后修改: 2026-03-24  最后修改者: BaiBinnan
移植日期: 2026-08-10
"""
...
def clip_boxes(boxes: np.ndarray, shape: Tuple[int], normalize=False):
    """检测框原图坐标裁剪，还原后的检测框大小不应超出原图并可归一化。
