...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.layoutWidget = QtWidgets.QWidget(self.annotatePage)
        self.layoutWidget.setGeometry(QtCore.QRect(9, 9, 562, 82))
        ...
        self.cpuBtn = QtWidgets.QRadioButton(self.layoutWidget)
        ...
        self.gpuBtn = QtWidgets.QRadioButton(self.layoutWidget)
        ...
        self.modelInputBtn = QtWidgets.QPushButton(self.layoutWidget)
        ...
        self.modelInput_2 = QtWidgets.QLineEdit(self.layoutWidget)
        self.modelInput_2.setReadOnly(True)
        self.modelInput_2.setObjectName("modelInput_2")
        self.horizontalLayout_11.addWidget(self.modelInput_2)
        self.modelInputBtn_2 = QtWidgets.QPushButton(self.layoutWidget)
        self.modelInputBtn_2.setObjectName("modelInputBtn_2")
        self.horizontalLayout_11.addWidget(self.modelInputBtn_2)
        self.verticalLayout_5.addLayout(self.horizontalLayout_11)
        self.layoutWidget1 = QtWidgets.QWidget(self.annotatePage)
        self.layoutWidget1.setGeometry(QtCore.QRect(10, 215, 302, 22))
        self.layoutWidget1.setObjectName("layoutWidget1")
        self.horizontalLayout_9 = QtWidgets.QHBoxLayout(self.layoutWidget1)
        self.horizontalLayout_9.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_9.setObjectName("horizontalLayout_9")
        self.annotateStatusLabel_2 = QtWidgets.QLabel(self.layoutWidget1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.annotateStatusLabel_2.sizePolicy().hasHeightForWidth())
        self.annotateStatusLabel_2.setSizePolicy(sizePolicy)
        self.annotateStatusLabel_2.setMinimumSize(QtCore.QSize(80, 0))
        self.annotateStatusLabel_2.setMaximumSize(QtCore.QSize(200, 16777215))
        self.annotateStatusLabel_2.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.annotateStatusLabel_2.setObjectName("annotateStatusLabel_2")
        self.horizontalLayout_9.addWidget(self.annotateStatusLabel_2)
        self.annotateProgressBar = QtWidgets.QProgressBar(self.layoutWidget1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.modelInputBtn_2.setText(_translate("MainWindow", "浏览"))
        self.annotateStatusLabel_2.setText(_translate("MainWindow", "无作业"))
